...
<?php
    ...
    $result = mysqli_query($conn, "SELECT monthname(bulan)as bulan,kontenMendidik,kontenTidakMendidik FROM yutuber ORDER BY MONTH(bulan) ASC");  
    ...
    while ($res = mysqli_fetch_array($result)) {
        ...
        $kontenMendidik=$kontenMendidik."".$res['kontenMendidik'].",";
        $kontenTidakMendidik=$kontenTidakMendidik."".$res['kontenTidakMendidik'].",";
    }
    ...
    series: [
        {
            name: 'konten mendidik',
            data: [$kontenMendidik]
        },
        {
            name: 'konten tidak mendidik',
            data: [$kontenTidakMendidik]
        }
    ]
};
</script>"
...
var options = {
    chart: {
        width: 1160,
        height: 650,
        title: 'Penurunan edukasi di youtube',
        format: '1,000'
    },
    yAxis: {
        title: 'Bulan'
